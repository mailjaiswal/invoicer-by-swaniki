    ...
    <div className="space-y-8">
        ...
        <section aria-labelledby="outstanding-heading" className="space-y-3">
          ...
          {outstandingInvoices.length > 0 ? (
            ...
            <EmptyState
              ...
              description="No outstanding invoices. New invoices that are unpaid will appear here."
            />
          )}
        </section>
      )}
      ...
      <section aria-labelledby="recent-heading" className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <Link
            href="/invoices"
            className="flex h-10 items-center gap-1 rounded-lg px-3 text-sm font-medium text-stone-600 hover:bg-stone-100 dark:text-stone-300 dark:hover:bg-stone-800"
          >
            View all
